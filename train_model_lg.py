...
output_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\lg_{current_time}_{split_ratio_str}{input_file[39:]}.csv'
output_xlsx_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\lg_{current_time}_{split_ratio_str}{input_file[39:]}.xlsx'
