...
try:
    ...
    print("xgboost未安装，将无法运行XGBoost模型")
    XGB_AVAILABLE = False
...
# 读取数据，跳过第一行标题行
input_file = r'D:\Study\QoE_QoS2\论文写作\实验程序\data2\基准数据\label3_data2_ACDG10H_1min.csv'
...
output_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\xgb_{current_time}_{split_ratio_str}{input_file[39:]}.csv'
output_xlsx_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\xgb_{current_time}_{split_ratio_str}{input_file[39:]}.xlsx'
