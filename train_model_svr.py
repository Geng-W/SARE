...
output_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\svr_{current_time}_{split_ratio_str}{input_file[39:]}.csv'
output_xlsx_file = rf'D:\Study\QoE_QoS2\论文写作\实验程序\data2\different models\svr_{current_time}_{split_ratio_str}{input_file[39:]}.xlsx'
...
if use_grid_search:
    ...
    # 注意：SVR没有random_state参数，所以我们只运行一次
    all_runs_metrics = []
